...
var Api_CM_BINDAPPLY_A5_submitApply_Request =function () {
    this.api= "Api_CM_BINDAPPLY_A5_submitApply_Request";
	...
	this.shoplist;//申请绑定的门店id列表;格式为shopaid和shoptype用竖线分隔;同Api_CM_BIND_SHOP_A1_Request;多个用逗号分隔-无字典对应
	this.card_typelist;//申请绑定的卡种id列表;用逗号分隔-无字典对应
...
////申请绑定的门店id列表;格式为shopaid和shoptype用竖线分隔;同Api_CM_BIND_SHOP_A1_Request;多个用逗号分隔-无字典对应
this.setShoplist    = function (c){this.data.shoplist    = c ; }
////申请绑定的卡种id列表;用逗号分隔-无字典对应
this.setCard_typelist    = function (c){this.data.card_typelist    = c ; }

}


//警告 : 不要写成 {Api_CM_BINDAPPLY_A5_submitApply_Request}
module.exports = Api_CM_BINDAPPLY_A5_submitApply_Request;
